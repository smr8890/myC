...
| **题号**            | **题目**           | **类型**   | **难度** |
| ------------------- | ------------------ | ---------- | -------- |
| [1531](#CZ864)      | 奇怪的数字         | 枚举，排序 | 1        |
| [1542](#g8IoE)      | 数列               | 枚举       | 1        |
| [1548](#WWlR1)      | 回文串             | 枚举       | 1        |
| [1549](#oU89U)      | 2的幂次 I          | STL，查找  | 1        |
| [1553](#hQ5w7)      | 数字               | 枚举       | 1        |
| [1559](#sR5xx)      | 奇偶数位           | 模拟       | 1        |
| [1575](#nHhwp)      | 四位数             | 循环、排序 | 1        |
| [1530](#CcKzN)      | Game               | 模拟       | 2        |
| [1538](#RHYs3)      | 打字机             | 队列，STL  | 2        |
| [1539](#qYusL)      | 区间               | 枚举，暴力 | 2        |
| [1541](#nPIKA)      | 卷积               | 模拟       | 2        |
| [1547](#mMejN)      | 圆                 | 数学       | 2        |
| [1576](#byD0Q)      | 分段               | 枚举       | 2        |
| [1583](#Axe84)      | 彩球               | 枚举       | 2        |
| [1484](1484 刷油漆) | 刷油漆             | 统计       | 3        |
| [1556](#OlRsm)      | 和                 | 递推，容斥 | 3        |
| [1560](#tXPX6)      | 平方数             | 数学，枚举 | 3        |
| [1567](#PcWl7)      | 3个矩形与1个正方形 | 暴力       | 3        |
| [1578](#rsezV)      | 拼图               | 暴力       | 3        |
| [1565](#hkWJN)      | Markdown表格       | 模拟       | 4        |
...
1. 枚举![](https://smr-typora.oss-cn-guangzhou.aliyuncs.com/img/bf98c0ddcbe9c1e535f767c78c3aa813.svg)从![](https://cdn.nlark.com/yuque/__latex/5a7999fca1469039ee6079530f3d3e0a.svg#card=math&code=10 \sim 10^5&id=WoYR8), 再枚举![](https://smr-typora.oss-cn-guangzhou.aliyuncs.com/img/712ecf7894348e92d8779c3ee87eeeb0.svg)，从![](https://cdn.nlark.com/yuque/__latex/79c4b81356f543a64548e749e91ba7db.svg#card=math&code=1\sim 9&id=eTjXY)，![](https://cdn.nlark.com/yuque/__latex/7ff0bb996c05074ca5a050cea9b70d70.svg#card=math&code=n %3D x \times y&id=k1gQR)，计算![](https://smr-typora.oss-cn-guangzhou.aliyuncs.com/img/df378375e7693bdcf9535661c023c02e.svg)的数码是否和![](https://smr-typora.oss-cn-guangzhou.aliyuncs.com/img/dfaa6128a78bc49e0b454a97d60830b8.svg)的数码是否相同；如果相同的话，那么![](https://smr-typora.oss-cn-guangzhou.aliyuncs.com/img/df378375e7693bdcf9535661c023c02e.svg)即为符合条件的数。
2. 将这样的数排序输出即可。
## 1542 数列
### 题意
